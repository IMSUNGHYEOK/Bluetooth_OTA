...
import com.qualcomm.qti.EMTechOTA.Consts;
import com.qualcomm.qti.EMTechOTA.R;
import com.qualcomm.qti.EMTechOTA.gaia.MainGaiaManager;
import com.qualcomm.qti.EMTechOTA.models.gatt.GATTServices;
import com.qualcomm.qti.EMTechOTA.services.BluetoothService;
import com.qualcomm.qti.EMTechOTA.services.GAIAGATTBLEService;
...
public class MainActivity extends ServiceActivity implements View.OnClickListener,
     ...
     * {@link com.qualcomm.qti.EMTechOTA.gaia.MainGaiaManager.Features Features}. This array is used as follows to know
        ...
        if (mService != null && mService.getConnectionState() == BluetoothService.State.CONNECTED) {
            switch (v.getId()) {
                ...
                case R.id.bt_upgrade:
                    Intent intentUpgrade = new Intent(this, CustomUpgradeActivity.class);
    ...
    private void init() {
        ...
        String Name = intent.getExtras().getString("DeviceName");
        String Address = intent.getExtras().getString("DeviceAddress");
        //txt_Device_Name = (TextView)findViewById(R.id.txt_Device_Name);

        //txt_Device_Name.setText(txt_Device_Name.getText().toString() + Name.toString());
        ...
        mTextViewDeviceAddress = (TextView)findViewById(R.id.txt_Device_Address);
        mTextViewDeviceAddress.setText(mTextViewDeviceAddress.getText().toString() + Address);
     ...
     * {@link com.qualcomm.qti.EMTechOTA.gaia.MainGaiaManager.Features Features}.</p>
